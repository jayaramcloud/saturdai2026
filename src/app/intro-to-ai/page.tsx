...
const SLIDES: Slide[] = [
  {
    ...
    alt: "Large-type numbered diagram titled Who's Doing What in AI, running left to right in ascending order of AI involvement: Not Using AI Yet (0), People with a Personal Life card (1), Enterprises building with AI containing cards for Professional Life — be a 5x engineer (2) and Building AI for companies (3), and AI Builders — OpenAI, Anthropic, Gemini, DeepSeek (4, with a researcher icon). A strip below gives the car analogy: people drive, enterprises assemble, builders design the engine.",
    paragraph:
