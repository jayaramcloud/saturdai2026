/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d224ac99d50fd5c161d3cbee9cc09be)
// Runtime types generated with workerd@1.20260426.1 2024-11-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_GUACAMOLE_URL: string;
		GUACAMOLE_USER: string;
		GUACAMOLE_PASS: string;
		SATURDAI_API_SECRET: string;
		SSH_PASS: string;
		NEXT_PUBLIC_WETTY_URL: string;
	}
}
